    ...
    for i, text in enumerate(reviews):
        ...
        for word in word_list:
            if word in dictionary:
                feature_matrix[i, dictionary[word]] = 1 each word has the same weight
                #feature_matrix[i, dictionary[word]] += 1 # weight of words increases with repetition (does not give better results)
